...
import com.github.amondeshir.rustroverronremix.language.psi.RONList
...
import com.github.amondeshir.rustroverronremix.language.psi.childOfType
...
private class InferenceBuilder(
    ...
    private fun TypeWithFieldOwner.unwrapVariantNewType() =
        // don't unwrap options, as this is already dofindElementsByNamene by unwrapNewTypes,
